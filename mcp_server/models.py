...
#   timestamp: 2025-06-28T15:23:35+00:00
...
class CertificateParameters(BaseModel):
    Cent: str = Field(..., description='Roll', examples=['B18-006'])
    MName: str = Field(..., description='Mother Name', examples=['Sana Khan'])
    Name: str = Field(..., description='Name', examples=['Abdul Khan'])
    RROLL: str = Field(..., description='No.', examples=['XXX6'])
